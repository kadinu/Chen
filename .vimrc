...
" Bundle 'javacomplete'                     "Java 补全插件
" Bundle 'vim-javacompleteex'               "更好的 Java 补全插件
Bundle 'Mark--Karkat'
Bundle 'lookupfile'
" Bundle 'Visual-Mark'                      "好像与折叠有点冲突
...
Bundle 'taglist.vim'
Bundle 'TxtBrowser'
" Bundle 'ZoomWin'                          "还原时着色失效，quickfix中使用出现错误
...
let g:DoxygenToolkit_authorName="Atom"
let g:DoxygenToolkit_licenseTag="Free license"
...
"  < lookupfile 插件配置 >
" -----------------------------------------------------------------------------
" 在lookupfile中查找文件非常简单，只要输入部分的文件名，就可以找到符合条件的文件
...
" -----------------------------------------------------------------------------
" 有目录村结构的文件浏览插件
nmap <F6> :NERDTreeToggle<CR>               " 常规模式下输入 F6 调用插件
imap <F6> <ESC>:NERDTreeToggle<CR>          " 插入模式下输入 F6 调用插件
...
imap <F4> <ESC>:SrcExplToggle<CR>           "打开/闭浏览窗口
...
nmap <F7> :TlistClose<CR>:TagbarToggle<CR>               " 常规模式下输入 F7 调用插件
imap <F7> <ESC>:TlistClose<CR>:TagbarToggle<CR>          " 插入模式下输入 F7 调用插件
...
nmap <F8> :TagbarClose<CR>:Tlist<CR>               " 常规模式下输入 F8 调用插件
imap <F8> <ESC>:TagbarClose<CR>:Tlist<CR>          " 插入模式下输入 F8 调用插件
